// Single source of truth for brand + LINE contact.
// Every CTA in the site reads from here — do not hardcode the LINE URL elsewhere.
// Override via .env (VITE_LINE_*) for staging/prod without touching code.
